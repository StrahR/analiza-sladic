...
class TestScraper(unittest.TestCase):
    ...
    def test_scrape_range(self, mock_page_content, mock_save):
        ...
        scrape(self.url_base, self.filename_base, start=7, end=10)
        ...
        mock_save.assert_any_call("asd", const.directory, "07.html")
        mock_save.assert_any_call("asd", const.directory, "08.html")
        mock_save.assert_any_call("asd", const.directory, "09.html")
        mock_save.assert_any_call("asd", const.directory, "10.html")
    ...
    def test_scrape_full(self, mock_page_content, mock_save):
        ...
        scrape(self.url_base, self.filename_base)
        ...
        mock_save.assert_any_call("asd", const.directory, "01.html")
        mock_save.assert_any_call("asd", const.directory, "02.html")
        mock_save.assert_any_call("asd", const.directory, "03.html")
        mock_save.assert_not_called_with("asd", const.directory, "04.html")
